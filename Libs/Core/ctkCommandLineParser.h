...
public:
   ...
   * the QVariant/QMetaType type of the default value does not match <code>type</code>, an
   ...
   * @throws std::logic_error If the QVariant/QMetaType type of <code>defaultValue</code>
   ...
   * parser.addArgument("long-argument", "l", QVariant::String); // Qt 5
   * parser.addArgument("long-argument", "l", QMetaType::QString); // Qt 6
   * QStringList args;
